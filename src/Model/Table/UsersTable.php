...
class UsersTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->hasMany('VistaReporteProductos', [
            'foreignKey' => 'user_id',
        ]);
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->notEmptyString('password', 'No puedes dejar la contraseña en blanco', 'create')
            ->allowEmptyString('password', 'La contraseña es opcional en edición', 'update');
        ...
        $validator
            ->scalar('estado_user')
            ->maxLength('estado_user', 1)
            ->allowEmptyString('estado_user');
