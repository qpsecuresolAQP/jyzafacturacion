...
class PagosLaboratoriosHistorialTable extends Table
{
    public function initialize(array $config): void
    {
        parent::initialize($config);

        $this->setTable('pagos_laboratorios_historial');
        ...
        $this->hasMany('PagosLaboratoriosHistorialDistribuciones', [
    ...
    public function validationDefault(Validator $validator): Validator
    {
        $validator
            ...
            ->requirePresence('laboratorio_id', 'create')
            ->notEmptyString('laboratorio_id');
