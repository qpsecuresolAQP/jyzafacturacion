        ...
        <div class="col-md-10 offset-md-1">
            ...
            <?php if (!$this->Permisos->tiene('Productos', 'edit')): ?>
                <div class="alert alert-danger" role="alert">
                    <i class="fas fa-lock"></i> No tienes permisos para editar productos.
                </div>
            <?php else: ?>
                ...
                <div class="col-12 mb-4">
                    <h3 class="text-info"><i class="fas fa-box"></i> Editar Producto</h3>
                </div>
                ...
                <div class="col-12 text-center">
                    <?= $this->Form->button(__('Actualizar Producto'), ['class' => 'btn btn-info']) ?>
