...
<div class="container mt-4 mb-4">
    <div class="row">
        <div class="col-md-10 offset-md-1">
            <?php if (!$this->Permisos->tiene('Recordatorios', 'edit')): ?>
            ...
            <?php else: ?>
                ...
                <div class="col-12 mb-4">
                    <h3 class="text-info">
                        <i class="fas fa-bell"></i> Editar Recordatorio
                    </h3>
                </div>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <?= $this->Form->hidden('paciente_id', [
                        'id' => 'pacienteId',
                        'value' => $recordatorio->paciente_id,
                    ]) ?>
                </div>
                ...
                <div class="col-12 text-center">
                    <?= $this->Form->button(__('Actualizar Recordatorio'), ['class' => 'btn btn-info']) ?>
                </div>
