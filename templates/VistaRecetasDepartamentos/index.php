<?php $this->assign('title', 'Reporte de Recetas por Procedencia'); ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelector('form').addEventListener('submit', function (event) {
            ...
            const url = `<?= $this->Url->build(['controller' => 'VistaRecetasDepartamentos', 'action' => 'exportarPdf']) ?>?departamento_id=${departamentoId}&start_date=${startDate}&end_date=${endDate}`;
        ...
        document.getElementById('exportPdfBtn').addEventListener('click', function () {
            ...
            const url = `<?= $this->Url->build(['controller' => 'VistaRecetasDepartamentos', 'action' => 'exportarPdf']) ?>?departamento_id=${departamentoId}&start_date=${startDate}&end_date=${endDate}&download=1`;
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        document.getElementById('exportExcelBtn').addEventListener('click', function (event) {
            ...
            const url = `<?= $this->Url->build(['controller' => 'VistaRecetasDepartamentos', 'action' => 'exportarExcel']) ?>?${params.toString()}`;
            window.location.href = url;
        });
    });    
</script>