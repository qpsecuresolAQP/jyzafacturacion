...
<body>
    <div class="section">
        <div class="prescription-info">
            <?php if (!empty($consulta->recetas_consultas)): ?>
                <?php foreach ($consulta->recetas_consultas as $index => $receta): ?>
              <?php
    
    $receta->descripcion = str_replace('windowtext', '#000000', $receta->descripcion);
    ?>   
    <div class="header">
        <table width="100%">
            <tr>
    ...
    <div class="separator"></div><br>
                   <div style="font-size: 8pt !important;">
                    ...
                    <div class="signature">
                        ...
                        <p><?= h($consulta->doctore->especialidad ?? 'No Especificado') ?></p>
                    </div>
                     -->
                    <?php
                    if ($index !== count($consulta->recetas_consultas) - 1): ?>
                        <div style="page-break-after: always;"></div>
                    <?php endif; ?>
                <?php endforeach; ?>
            <?php else: ?>
                <p>No se registraron recetas médicas.</p>
            <?php endif; ?>
        </div>
    </div>       
