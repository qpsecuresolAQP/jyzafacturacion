        ...
        <div class="col-md-8 offset-md-2">
            ...
            <?php if (!$this->Permisos->tiene('CategoriasProductos', 'edit')): ?>
                <div class="alert alert-danger" role="alert">
                    <i class="fas fa-lock"></i> No tienes permisos para editar categorías de productos.
                </div>
            <?php else: ?>
                ...
                <div class="col-12 mb-4">
                    <h3 class="text-info"><i class="fas fa-tag"></i> Editar Categoría de Producto</h3>
                </div>
                ...
                <div class="col-12 text-center">
                    <?= $this->Form->button(__('Actualizar Categoría'), ['class' => 'btn btn-info']) ?>
