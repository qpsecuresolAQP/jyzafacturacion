        ...
        <div class="col-md-12 ">
            <?php if (!$this->Permisos->tiene('Examenes', 'add')): ?>
                <div class="alert alert-danger" role="alert">
                    <i class="fas fa-lock"></i> No tienes permisos para registrar exámenes.
                </div>
            <?php else: ?>
                <?= $this->Form->create($examene, ['class' => 'row g-3']) ?>

                <div class="col-12 mb-4">
                    <h3 class="text-info"><i class="fas fa-flask"></i> Registrar Nuevo Examen</h3>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <small class="text-muted">Lo que se le paga al laboratorio por este examen (informativo, no se cobra al paciente).</small>
                </div>
                ...
                <div class="col-12 text-center">
                    <?= $this->Form->button(__('Guardar Examen'), ['class' => 'btn btn-info', 'id' => 'submitButton']) ?>
