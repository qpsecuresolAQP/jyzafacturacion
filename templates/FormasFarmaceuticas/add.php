...
<div class="container mt-4 mb-4">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <!-- Alerta de permiso -->
            <?php if (!$this->Permisos->tiene('FormasFarmaceuticas', 'add')): ?>
                <div class="alert alert-danger" role="alert">
                    <i class="fas fa-lock"></i> No tienes permisos para agregar formas farmacéuticas.
                </div>
            <?php else: ?>
                ...
                <div class="col-12 mb-4">
                    <h3 class="text-info"><i class="fas fa-capsules"></i> Agregar Forma Farmacéutica</h3>
                </div>
                ...
                <div class="col-12 text-center">
                    <?= $this->Form->button(__('Guardar Forma Farmacéutica'), ['class' => 'btn btn-info']) ?>
