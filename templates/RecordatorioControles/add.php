...
<div class="container mt-4 mb-4">
	<div class="row">
		<div class="col-md-10 offset-md-1">
			<?php if ($recordatorioControl->isNew() && !$this->Permisos->tiene('RecordatorioControles', 'add')): ?>
				<div class="alert alert-danger" role="alert">
					<i class="fas fa-lock"></i> No tienes permisos para registrar controles.
				</div>
			<?php elseif (!$recordatorioControl->isNew() && !$this->Permisos->tiene('RecordatorioControles', 'edit')): ?>
				<div class="alert alert-danger" role="alert">
			...
			<?php else: ?>
				...
				<div class="col-12 mb-4">
					<h3 class="text-info">
						...
						<?= $recordatorioControl->isNew() ? 'Nuevo Control' : 'Editar Control' ?>
					</h3>
				</div>

				<div class="col-md-12 mb-3">
					<?php if (!empty($recordatorioId)): ?>
						<?= $this->Form->hidden('recordatorio_id', ['value' => $recordatorioId]) ?>
					<?php else: ?>
				...
				<div class="col-12 text-center">
					<?= $this->Form->button(
						$recordatorioControl->isNew() ? __('Guardar Control') : __('Actualizar Control'),
						['class' => 'btn btn-info']
					) ?>
				</div>
