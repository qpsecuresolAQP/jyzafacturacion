 ...
 * @var iterable<\App\Model\Entity\PagosLaboratoriosHistorial> $pagosHistorial
...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <h3 class="fw-bold mb-0">
            <i class="fas fa-history"></i> Historial de Pagos a Laboratorios
        </h3>
            ...
            <tbody>
                <?php foreach ($pagosHistorial as $pago): ?>
                    <tr>
                        ...
                        <td><?= h($pago->laboratorio->nombre ?? '-') ?></td>
